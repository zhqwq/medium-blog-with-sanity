    ...
    <main>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
        ...
        <label className="block mb-5 ">
          ...
          <input {...register('name', { required: true })} className="shadow border rounded py-2 px-3 m5-1 block w-full ring-yellow-500" placeholder="John Appleseed" type="text" />
        </label>
        <label className="block mb-5 ">
          <span className="text-gray-700">Email</span>
          <input {...register('email', { required: true })} className="shadow border rounded py-2 px-3 m5-1 block w-full ring-yellow-500" placeholder="John Appleseed" type="text" />
        </label>
        <label className="block mb-5 ">
          <span className="text-gray-700">Comment</span>
          <textarea {...register('comment', { required: true })} className="shadow border rounded py-2 px-3 m5-1 block w-full ring-yellow-500" placeholder="John Appleseed" rows={8} />
        </label>
        ...
        <input className='shadow bg-yellow-500 hover:bg-yellow-400 focus:outline-none text-white px-4 py-2 rounded cursor-pointer' type="submit" />
      </form>
